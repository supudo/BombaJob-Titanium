function Controller() {
    ...
    fetchOffersPeople ? $.__views.__alloyId17.addEventListener("focus", fetchOffersPeople) : __defers["$.__views.__alloyId17!focus!fetchOffersPeople"] = true;
    ...
    __defers["$.__views.__alloyId17!focus!fetchOffersPeople"] && $.__views.__alloyId17.addEventListener("focus", fetchOffersPeople);
    _.extend($, exports);
}
