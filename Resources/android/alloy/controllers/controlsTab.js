function Controller() {
    ...
    $.__views.__alloyId2.add($.__views.progressIndicator);
    ...
    $.__views.statusIndicator = Ti.UI.Android.createProgressIndicator({
        ns: Ti.UI.Android,
        id: "statusIndicator",
        message: "Loading...",
        min: "0",
    ...
    $.__views.__alloyId2.add($.__views.statusIndicator);
